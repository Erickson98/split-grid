  ...
  if (trackPercentage.length) {
    ...
    if (track$1 !== null) {
      this.percentageToPixels =
        this.computedPixels[track$1].numeric / trackPercentage[track$1].numeric;
    }
  }
...
var createGutter = function (direction, options) { return function (gutterOptions) {
    ...
    var trackMaxSize = direction === 'column' ? 'columnMaxSize' : 'rowMaxSize';
...
var Grid = function Grid(options) {
    ...
    this.options.columnGutters.forEach(function (gutterOptions) {
        this$1$1.columnGutters[gutterOptions.track] = createGutter(
            'column',
            this$1$1.options
        )(gutterOptions);
    });
    ...
    this.options.rowGutters.forEach(function (gutterOptions) {
        this$1$1.rowGutters[gutterOptions.track] = createGutter(
            'row',
            this$1$1.options
        )(gutterOptions);
    });
...
Grid.prototype.removeColumnGutter = function removeColumnGutter (track, immediate) {
    ...
    if (this.columnGutters[track]) {
        this.columnGutters[track].destroy(immediate, function () {
            delete this$1$1.columnGutters[track];
        });
    }
};
...
Grid.prototype.removeRowGutter = function removeRowGutter (track, immediate) {
    ...
    if (this.rowGutters[track]) {
        this.rowGutters[track].destroy(immediate, function () {
            delete this$1$1.rowGutters[track];
        });
    }
};
...
Grid.prototype.destroy = function destroy (immediate) {
    ...
    Object.keys(this.columnGutters).forEach(function (track) { return this$1$1.columnGutters[track].destroy(immediate, function () {
            delete this$1$1.columnGutters[track];
        }); }
    );
    Object.keys(this.rowGutters).forEach(function (track) { return this$1$1.rowGutters[track].destroy(immediate, function () {
            delete this$1$1.rowGutters[track];
        }); }
    );
};
